...
public class SeederClient {
     ...
     *            the data file
     */
    public SeederClient(final Properties configuration, final TrackedTorrent torrent, final Path torrentFile,
	    final Path dataFile) {
	...
	try {
	    LOGGER.info("Trying to stop and delete {} and {}. Number of client {}",
	...
	if (leechers > 0 && seeder == null) {
	    LOGGER.info(torrentFile + ": {} leechers, {} seeders", leechers, seeders);
		...
		LOGGER.info("No more leecher for file: {}: {} leechers, {} seeders",
		...
		final String keepActiveString = configuration.getProperty("torrent.keep.seeder.active.millisecond",
			"600000");
