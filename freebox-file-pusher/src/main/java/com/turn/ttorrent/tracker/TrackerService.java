...
public class TrackerService implements Container {
    ...
    private void recordParam(final Map<String, BEValue> params, final String key,
	    String value) {
	try {
     ...
     */
    private void serveError(final Response response, final OutputStream body,
	    final Status status, final ErrorMessage.FailureReason reason) throws IOException {
