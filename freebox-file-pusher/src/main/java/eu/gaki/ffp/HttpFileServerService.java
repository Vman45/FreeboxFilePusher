...
public class HttpFileServerService implements Container {
    ...
    // http://192.168.1.42/Usenet/Mad Max Au-delà Du Dôme Du Tonnerre (1985)/Mad.Max.Beyond.Thunderdome.1985.MULTi.1080p.BluRay.x264-ROUGH/mad.max.beyond.thunderdome.1985.multi.1080p.bluray.x264-rough.mkv
