...
public class FilesCompresor {
	...
	final String compressionMethodString = configuration.getProperty("ffp.compress.method", "8");
	final int compressionMethod = Integer.valueOf(compressionMethodString);
	final String compressionLevelString = configuration.getProperty("ffp.compress.level", "0");
	...
	try (ZipArchiveOutputStream zipOutputStream = new ZipArchiveOutputStream(zipFile.toFile());
